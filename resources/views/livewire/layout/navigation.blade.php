    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <button wire:click="logout" 
                        class="w-full text-left block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-red-600 hover:text-red-800 hover:bg-gray-50 hover:border-red-300 focus:outline-none focus:text-red-800 focus:bg-gray-50 focus:border-red-300 transition duration-150 ease-in-out"
                >
                    {{ __('Sair') }}
                </button>
            </div>
