<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-semibold text-gray-900">Receitas</h2>
            <button
                    ...
                    @forelse($incomes as $income)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $income->due_date->format('d/m/Y') }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900">
                                {{ $income->description }}
                                @if($income->observation)
                                    <p class="text-xs text-gray-500">{{ $income->observation }}</p>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    {{ $income->status === 'received' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button
                                    wire:click="openFormModal({{ $income->id }})"
                ...
                <div class="relative bg-white rounded-lg max-w-lg w-full">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900">
                            {{ $editingIncome ? 'Editar' : 'Nova' }} Receita
                        </h3>
